...
class ITSMIntegration:
    def __init__(self):
        self.base_url = "https://{itms remedy api endpoint here}:{remedy port here}/baocdp/rest"
    ...
    def create_change_request(self, deployment_data):
        ...
        try:
            ...
            create_url = "https://{itms remedy api endpoint here}:{remedy port here}/baocdp/rest/process/:SBSA-OA-Generic_ITSM_Interface:ChangeManagement:CreateChange/execute"
    ...
    def update_work_info(self, change_id, work_info_type, attachment_data=None, attachment_name=None):
        ...
        try:
            ...
            update_url = "https://{itms remedy api endpoint here}:{remedy port here}/baocdp/rest/process/:SBSA-OA-Generic_ITSM_Interface:ChangeManagement:WorkUpdate/execute?mode=sync"
    ...
    def close_change_request(self, change_id, status_reason):
        ...
        try:
            ...
            close_url = "https://{itms remedy api endpoint here}:{remedy port here}/baocdp/rest/process/:SBSA-OA-Generic_ITSM_Interface:ChangeManagement:CloseChange/execute?mode=sync"
